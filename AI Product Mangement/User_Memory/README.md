...
*   **Long-Term Memory Storage:** While the active session lives in memory, persistent user traits are synced asynchronously to a Data Warehouse (e.g., Snowflake/BigQuery). This enables downstream data pipelines to utilize rich, LLM-inferred segments for offline analytics, cohort analysis, and long-term CRM campaigns.
