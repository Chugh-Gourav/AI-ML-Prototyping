...
class AgentState:
    agent_id: str
    current_state: str  # IDLE, SEARCHING_FLIGHTS, FLIGHT_REDIRECTED, SEARCHING_STAYS, STAY_REDIRECTED, SEARCHING_TRANSPORT, FULLY_REDIRECTED, ABANDONED, SEARCHING_PACKAGES, PACKAGE_REDIRECTED, PLANNING_ROAD_TRIP, CONVERSATIONAL_STAYS_SEARCH
